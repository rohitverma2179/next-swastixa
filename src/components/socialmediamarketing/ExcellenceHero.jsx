          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="relative w-full max-w-[560px]">
              ...
              <div
                ...
                "
              >
                <img loading="lazy" decoding="async"                   src="https://pub-6aea620a48a5427f992db658caf5fb4a.r2.dev/swastixaservice/service-all-eight-pages-images/swastixa-service-social-media-marketing.webp"
                  alt="Team Meeting"
                  className="
                    w-full
                    h-[420px]
