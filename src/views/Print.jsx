...
const printProjects = [
  {
    ...
    thumbnail: "https://cdn.swastixa.com/swastixawork/social-media-image-reels/print/printing-media-thumbnail.webp",
    type: "pdf",
    pdfUrl: "https://cdn.swastixa.com/swastixawork/social-media-image-reels/print/printing-media.pdf",
  ...
  return (
    <main className="bg-black min-h-screen pt-24 md:pt-40">
      {/* <div className="relative z-10 px-4">
        <h1 className='text-white text-center text-4xl md:text-6xl lg:text-8xl font-bold tracking-tighter heading'>
